...
const CheckIcon = () => (
  <svg className="h-5 w-5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
    <path
      fillRule="evenodd"
      d="M16.707 5.293a1 1 0 010 1.414l-7.072 7.071a1 1 0 01-1.414 0L3.293 8.793a1 1 0 011.414-1.414l4.514 4.514 6.364-6.364a1 1 0 011.414 0z"
      clipRule="evenodd"
    />
  </svg>
);
